...
class NovelState(BaseModel):
    ...
    def add_message(self, sender: str, recipient: str, content: str, metadata: Dict[str, Any] = None) -> None:
    ...
    def calculate_progress(self) -> float:
        ...
        if self.status != ProjectStatus.COMPLETED:
            next_status_progress = status_weights[list(status_weights.keys())[list(status_weights.keys()).index(self.status) + 1]]
