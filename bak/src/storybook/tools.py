    ...
    def _run(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            content = {
                ...
                "metadata": {"url": url, "timestamp": response.headers.get("date")},
            }
...
class ToolsService:
    ...
    def __init__(self):
        ...
        self.vector_store = MongoDBAtlas(
            embedding_function=self.embeddings, persist_directory="./data/vector_store"
        )
    ...
    def get_research_tools(self) -> List[BaseTool]:
        ...
        return [
            ...
            create_retriever_tool(
                google_search, "google_search", "Search the web for information using Google"
            ),
            google_books,
            tavily_search,
            wikipedia_retriever,
    ...
    def store_document(self, content: str, metadata: Dict[str, Any]) -> str:
        ...
        ids = self.vector_store.add_texts(texts=[content], metadatas=[metadata])
        return ids[0]
