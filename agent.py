...
{% endif %}"""
            ...
            if hasattr(text_gen_pipeline, "model"):
                ...
                # Only set static KV cache if the model has generation_config attribute and it has cache_implementation
                if device_type == "cuda" and hasattr(model, "generation_config"):
