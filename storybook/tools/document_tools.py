...
class DocumentTools:
    ...
    def _search_manuscript(self, query: str, manuscript_id: Optional[str] = None, k: int = 5) -> str:
        ...
        try:
            ...
            results = self.document_store.get_manuscript_relevant_parts(manuscript_id, query, k)
