...
class TestGraph:
    ...
    def mock_agents(self):
        ...
        with (
            patch("storybook.graph.MarketResearcher") as mock_researcher,
            ...
            mock_analyzer_instance.analyze_progress.return_value = {
                "progress": "updated"
            }
    ...
    def test_conduct_market_research(self, mock_agents):
        ...
        mock_agents["researcher"].research_market.assert_called_once_with(
            "test_id", "Test Title"
        )
