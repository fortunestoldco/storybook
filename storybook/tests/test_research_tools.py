...
class TestResearchTools:
    ...
    def mock_tavily_search(self):
        with patch('storybook.tools.research_tools.TavilySearchAPIWrapper') as mock_tavily:
    ...
    def mock_tavily_tool(self):
        with patch('storybook.tools.research_tools.TavilySearchResults') as mock_tavily_tool:
            mock_tool = MagicMock()
    ...
    def test_init(self, mock_llm, mock_tavily_search, mock_firecrawl, mock_document_store):
        # Test initialization
        tools = ResearchTools()
    ...
    def test_get_research_tool(self, mock_llm, mock_tavily_search, mock_tavily_tool, mock_document_store):
    ...
    def test_get_web_crawl_tool(self, mock_llm, mock_tavily_search, mock_firecrawl, mock_document_store):
    ...
    def test_simulate_web_research(self, mock_llm, mock_tavily_search, mock_document_store):
        # Setup
        tools = ResearchTools()
    ...
    def test_crawl_and_save_webpage(self, mock_llm, mock_firecrawl, mock_document_store):
        # Setup
        tools = ResearchTools()
        ...
        with patch('storybook.tools.research_tools.WebBaseLoader') as mock_web_loader:
            ...
            mock_document_store.db.store_documents_with_embeddings.return_value = ["doc1"]
    ...
    def test_clean_research_output(self, mock_llm, mock_tavily_search, mock_document_store):
        # Setup
        tools = ResearchTools()
