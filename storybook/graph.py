...
class AgentConfig(TypedDict):
    ...
    research: Optional[LLMConfig]
    writing: Optional[LLMConfig]
    editorial: Optional[LLMConfig]
...
class StorybookState(TypedDict):
    ...
    agent_config: Optional[AgentConfig]  # LLM preferences for each team
...
def start_workflow(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "title": state["title"],
        "synopsis": state["synopsis"],
        "agent_config": agent_config,  # Include agent configuration
...
def save_graph_visualization(output_path: str = "graph.png") -> None:
    ...
    try:
        # Generate the PNG with custom styling using Mermaid syntax
        png_data = storybook.get_graph().draw_mermaid_png(
            draw_method=MermaidDrawMethod.API,
            curve_style=CurveStyle.CURVED,
            graph_attrs="""
            classDef supervisor fill:#c4a7e7,stroke:#6e6a86;
            classDef research fill:#ebbcba,stroke:#6e6a86;
            classDef writing fill:#9ccfd8,stroke:#6e6a86;
            classDef editorial fill:#f6c177,stroke:#6e6a86;
            
            class project_supervisor,research_supervisor,writing_supervisor,editorial_supervisor supervisor;
            class market_research,content_analysis,audience_analysis research;
            class world_building,character_development,subplot_integration,dialogue_enhancement,draft_writing writing;
            class story_arc_evaluation,continuity_check,language_polishing,quality_review editorial;
            """
        )
